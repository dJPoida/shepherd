...
declare module "@hakit/core" {
  ...
  > {
    ...
    alarmo: {
      ...
      arm: ServiceFunction<
        T,
        {
          // Name of entity that should be armed. @example alarm_control_panel.alarm
          entity_id: string;
          // Code to arm the alarm with. @example 1234
          code?: string;
          // Mode to arm the alarm in. @example away
          mode?: "away" | "night" | "home" | "vacation" | "custom";
          // Skip the exit delay. @example true
          skip_delay?: boolean;
          // Automatically bypass all sensors that prevent the arming operation. @example true
          force?: boolean;
        }
      >;
      ...
      disarm: ServiceFunction<
        T,
        {
          // Name of entity that should be disarmed. @example alarm_control_panel.alarm
          entity_id: string;
          // Code to disarm the alarm with. @example 1234
          code?: string;
        }
      >;
    };
  ...
  export interface CustomEntityNameContainer {
    names:
      ...
      | "sensor.upstairs_air_quality_sensor_temperature"
      | "sensor.upstairs_air_quality_sensor_carbon_dioxide_concentration"
      | "sensor.upstairs_air_quality_sensor_formaldehyde_concentration"
      | "sensor.upstairs_air_quality_sensor_humidity"
      | "sensor.upstairs_air_quality_sensor_voc_level"
      ...
      | "update.upstairs_air_quality_sensor_firmware"
